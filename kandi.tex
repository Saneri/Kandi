...
Software metric can be any metric that determines software quality in any way. There are defined sets of metrics e.g Halstead metrics \cite{al2005analysis}  but it is also possible to adjust a existing metric for specified software or implement a completely new metrics.
